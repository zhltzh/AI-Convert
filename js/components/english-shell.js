...
export function renderEnglishFooter() {
  return `<footer class="site-footer"><div class="container site-footer__inner"><span>© ${new Date().getFullYear()} Aixuno</span><span class="footer-links"><a href="../about.html">About</a><a href="../privacy.html">Privacy</a><a href="../changelog.html">Changelog</a></span><span>Your content stays in your browser.</span></div></footer>`;
}
