    ...
    <header class="site-header">
      <div class="container site-header__inner">
        ...
        <nav class="nav" aria-label="主导航">
          <a href="${home}#tools">工具</a><a href="${home}#how-it-works">教程</a><a href="${home}#faq">FAQ</a><a href="${englishTarget}" onclick="localStorage.setItem('ai-convert-locale','en')">EN</a>
        </nav>
      </div>
    </header>`;
}
